...
{strip}
	<style>
		...
		.buttonBlue {
			background-image: linear-gradient(to bottom, #1167ec 0px, #5ae0ff 100%);
		}
		.ripples {
			position: absolute;
			top: 0;
			...
			<div class="loginDiv widgetHeight">
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue">Entrar</button><br>
							<a class="forgotPasswordLink" style="color: #15c;">¿Olvidaste tu contraseña?</a>
						</div>
					</form>
				</div>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						<div class="group">
							<input id="fusername" type="text" name="username" placeholder="Usuario" >
							<span class="bar"></span>
							<label>Usuario</label>
						</div>
						<div class="group">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue forgot-submit-btn">Enviar</button><br>
							<span>Por favor rellena los campos.<a class="forgotPasswordLink pull-right" style="color: #15c;">Regresar al Login</a></span>
						</div>
					</form>
				</div>
			</div>
